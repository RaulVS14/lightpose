...
def set_light_level_color_temperature(_serialDevice, _lightLevelValue=50, _colourTemperatureValue=3900):
    ...
    if _serialDevice.isOpen():
        try:
            ...
            serial_msg = '25' + str(LUMINAIRE_ID) + '0017' + str(DALI_LIGHT_LEVEL_HEX_ARRAY[lightValIndex]) + str(
    ...
    if Port_name:
        ...
        if Serial_Device:
            ...
            while True:
                print("working")
                print(i)
                # Serial_Device exists, Write to port (this can be put in while true loop)

                # if i >= 20:
                #     i = 0

                set_light_level_color_temperature(Serial_Device, _lightLevelValue=50,
                                                  _colourTemperatureValue=2700 + i)  # , i * 5, 3900 + i * 100)
                i += 100
                # print("sending command", i * 5, 3900 + i * 100)
                time.sleep(0.2)
